...
class DataCollector(object):
    ...
    def collect_Financial_News_Data(self, company):
        ...
        try:
            dict_Sentiment_Score = self.data_manager.get_DB(company,"FinancialNewsData")
            
            # Scrape News and evaluate Sentiment Score
            if dict_Sentiment_Score is None:
                ...
                if not news:
                  raise Exception("Error News Fetch for Financial Data")
                    ...
                    for key in news:
                        ...
                        dict_Sentiment_Score[key] = averageSentimentScore

                if self.save_scraped_data_flag:
                    self.data_manager.save_DB(company, dict_Sentiment_Score, "FinancialNewsData" )
    ...
    def collect_Fundamental_Data(self, company):
        ...
        try:
            ...
            if dict_fundamental_data is None:
            ...
            if not dict_fundamental_data:
                  raise Exception("Fundamental Data Fetch Error")
    ...
    def collect_Technical_Data(self, company):
        ...
        try:
            ...
            if dict_technical_data is None :
